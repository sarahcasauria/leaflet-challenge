...
function createFeatures(earthquakeData) {
    ...
    // Send our earthquake layer to the createMap function
    createMap(earthquakeLayer);
}

// Define a function to create the earthquake map
function createMap(earthquakeLayer) {
  
    // Create the base layers. We want a greyscale map and satellite map
    ...
    var myMap = L.map("map", {
      ...
      zoom: 3,
      layers: [greyscale, earthquakeLayer]
    });
